...
public class DBOperations {
    ...
    public static User findeUserByNick(String nick){
        User user;
    ...
    public static User findeUserByName(String name){
        User user;
        //TODO: ver a lista
    ...
    public static User findeUserByEmail(String email){
        User user;
    ...
    public static User findeUserByTelefone(String telefone){
        User user;
